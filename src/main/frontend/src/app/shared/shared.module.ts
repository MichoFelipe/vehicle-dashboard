...
const SHARED_COMPONENTS = [NavbarComponent, HeaderComponent];

const SHARED_SERVICES = [UserService, VehicleService];

const SHARED_DIRECTIVES = [HighlightCodeDirective];

@NgModule({
  imports: [RouterModule, CommonModule, ...SHARED_MODULES],
